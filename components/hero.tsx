				...
				<div className="max-w-7xl mx-auto px-4 w-full">
					<div className="max-w-3xl text-white">
						...
						<div className="flex flex-col sm:flex-row gap-4">
							...
							<Button className="flex-1 group relative overflow-hidden rounded-md bg-white text-primary hover:bg-primary hover:text-white transition-all duration-700 px-6 py-4 text-lg font-medium shadow-lg cursor-pointer">
							...
							<Link
								...
								className="flex-1 px-6 py-4 backdrop-blur-md bg-white/20 border border-white/20 text-white font-medium rounded-md transition-all duration-300 flex items-center justify-center gap-2 relative overflow-hidden group text-lg"
							>
								{/* Wobble effect on hover */}
								<span className="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
								<Phone size={20} className="group-hover:animate-[wiggle_0.5s_ease-in-out]" />
